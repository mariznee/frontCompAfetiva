...
const PaginaQuatro = () => {
    ...
    return (
        <div className="container text-warning">
            ...
            <div className="row">
                <div className="col-6 align-self-center mr-3">
                    <br></br>
